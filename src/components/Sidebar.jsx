...
const Sidebar = () => {
	return (
		<aside className='lg:flex lg:w-[18%] lg:min-w-[230px] flex-shrink-0 lg:border-r border-["#DBDBDB] hidden'>
			<div className="sticky top-0 h-screen overflow-y-scroll [&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:'none']  ">
				{/* Sidebar Menus */}
				<div className='sticky top-0 flex justify-between items-center px-6 py-7 h-88px border-b border-["#DBDBDB] bg-white'>
